        ...
        <div className="lg:col-span-3">
            ...
            <div className="mt-4 p-6 rounded-lg bg-muted/50 border">
              <p className="text-lg text-muted-foreground">
                Harness the power of Flux to transform your text prompts into breathtaking images. It's fast, efficient, and capable of generating stunning visuals for any project.
              </p>
            </div>
