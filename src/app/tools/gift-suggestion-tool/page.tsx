                ...
                <CardContent>
                    <Accordion type="single" collapsible className="w-full">
                        <AccordionItem value="item-1">
                            ...
                            <AccordionContent>
                            Yes, our AI Gift Suggestion Tool is 100% free to use.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-2">
                            <AccordionTrigger>Does the tool provide links to buy the gifts?</AccordionTrigger>
                            <AccordionContent>
                            No, the tool focuses on providing creative ideas. It does not provide direct links to products to ensure the suggestions are unbiased.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-3">
                            <AccordionTrigger>Can I use this for any occasion?</AccordionTrigger>
                            <AccordionContent>
                            Absolutely. The tool is perfect for birthdays, anniversaries, holidays like Christmas or Diwali, or just to find a nice surprise for someone.
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
                </CardContent>
